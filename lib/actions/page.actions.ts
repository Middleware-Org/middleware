/**
 * Page Actions
 * Server Actions per la gestione delle pagine con invalidazione cache
 */
'use server';
...
import { PAGE_CACHE_TAGS } from '@/lib/services/page.service';
...
export async function createPageAction(
  ...
  try {
    ...
    revalidatePath('/[locale]/pages', 'page');
...
export async function updatePageAction(
  ...
  try {
    ...
    revalidateTag(PAGE_CACHE_TAGS.detail(slug));
    if (newSlug) revalidateTag(PAGE_CACHE_TAGS.detail(newSlug));
    revalidateTag(PAGE_CACHE_TAGS.all);
    revalidatePath('/admin/pages');
    revalidatePath('/[locale]/pages', 'page');
