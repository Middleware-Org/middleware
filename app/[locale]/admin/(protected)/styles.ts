...
const styles = {
  ...
  statCardHeader: cn("flex items-start gap-4 mb-4"),
  statIcon: cn("text-3xl"),
  statCardInfo: cn("flex-1"),
  statTitle: cn("text-lg font-semibold text-secondary mb-1"),
  statDescription: cn("text-sm text-secondary/60"),
  statCardFooter: cn("flex items-center justify-between pt-4 border-t border-secondary"),
  ...
  recentSectionLink: cn(
    "text-sm text-secondary/60 hover:text-tertiary transition-colors",
