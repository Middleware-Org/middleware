...
const styles = {
  ...
  badgeDate: cn("bg-secondary border-secondary py-1 px-2 w-fit"),
  badgeTitle: cn("bg-primary border-secondary py-1 px-2 w-fit"),
  badgeTextDate: cn("text-xs! md:text-base! text-primary"),
  badgeTextTitle: cn("text-xs! md:text-base!"),
  titleLink: cn("block min-h-11 py-1 -my-1"),
  title: cn("hover:underline text-3xl!"),
  authorInfo: cn("flex items-center gap-2.5"),
  authorLabel: cn("text-sm"),
  authorLink: cn("inline-flex items-center min-h-11 px-1 -mx-1 my-[-4px]"),
  authorLinkText: cn("text-sm hover:underline"),
  excerpt: cn("text-[14px] my-4! leading-relaxed"),
  readMore: cn("flex justify-between mb-4"),
